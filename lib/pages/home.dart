...
import 'package:cantique_moudang/pages/Detail.dart';
...
class _HomeState extends State<Home> {
        ...
        return new ListTile(
          ...
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (_) => Detail(
                    //filteredmot[index]['id'].toString(),
                    filteredmot[index]['title'],
  ...
  _getmot() async {
    ...
    final response = await rootBundle.loadString("assets/json/chants.json");
    List tempList = new List();
